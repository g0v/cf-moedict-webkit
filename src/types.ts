...
export const FONT_MAP: Record<string, FontConfig> = {
  ...
  'gwmel': { name: 'GenWanMin TW EL', displayName: '特細', category: '源雲明體' },
  'gwml': { name: 'GenWanMin TW L', displayName: '細體', category: '源雲明體' },
  'gwmr': { name: 'GenWanMin TW R', displayName: '標準', category: '源雲明體' },
  'gwmm': { name: 'GenWanMin TW M', displayName: '正明', category: '源雲明體' },
  'gwmsb': { name: 'GenWanMin TW SB', displayName: '中明', category: '源雲明體' },
